...
module Api
  module V1
    class UsersController < BaseController
      ...
      ALLOWED_INCLUDES = %w(user_languages user_languages.language language languages company user_images user_skills skills).freeze # rubocop:disable Metrics/LineLength
