...
RSpec.describe JobDigestSubscriberSyncService do
  describe '::call' do
    ...
    it 'returns array of JobDigestSubscriber:s if there are existing subscribtions' do
      email = 'watman-jbs-service@example.com'
      subscriber = FactoryGirl.create(:job_digest_subscriber, email: email)
