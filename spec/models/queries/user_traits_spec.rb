...
RSpec.describe Queries::UserTraits do
  describe '::by_filter' do
    it 'returns matching users' do
      ...
      interest1 = FactoryBot.create(:interest, id: 111_111)
      interest2 = FactoryBot.create(:interest, id: 111_112)

      # rubocop:disable Metrics/LineLength
      # user1
      FactoryBot.create(:user_skill, proficiency: 3, proficiency_by_admin: 2, user: user1, skill: skill1)
      FactoryBot.create(:user_skill, proficiency: 4, proficiency_by_admin: 3, user: user1, skill: skill2)
      FactoryBot.create(:user_language, proficiency: 3, proficiency_by_admin: 4, user: user1, language: language)
      FactoryBot.create(:user_interest, level: 3, level_by_admin: 4, user: user1, interest: interest1)
      FactoryBot.create(:user_interest, level: 3, level_by_admin: 4, user: user1, interest: interest2)
      # user2
      FactoryBot.create(:user_skill, proficiency: 3, proficiency_by_admin: 2, user: user2, skill: skill1)
      FactoryBot.create(:user_skill, proficiency: 4, proficiency_by_admin: 3, user: user2, skill: skill2)
      # user3
      FactoryBot.create(:user_skill, proficiency: 4, proficiency_by_admin: 3, user: user3, skill: skill2)
      # user4
      FactoryBot.create(:user_skill, proficiency: 3, proficiency_by_admin: 2, user: user4, skill: skill1)
      FactoryBot.create(:user_skill, proficiency: 4, proficiency_by_admin: 3, user: user4, skill: skill2)
      FactoryBot.create(:user_language, proficiency: 3, proficiency_by_admin: 4, user: user4, language: language)
      FactoryBot.create(:user_interest, level: 3, level_by_admin: 4, user: user4, interest: interest1)
      FactoryBot.create(:user_interest, level: 1, level_by_admin: 1, user: user4, interest: interest2)

      # Create skill filters
      FactoryBot.create(:skill_filter, skill: skill1, filter: filter, proficiency: 2, proficiency_by_admin: 2)
      FactoryBot.create(:skill_filter, skill: skill2, filter: filter, proficiency: 3, proficiency_by_admin: 3)
      ...
      FactoryBot.create(:language_filter, language: language, filter: filter, proficiency: 3, proficiency_by_admin: 3)
      ...
      FactoryBot.create(:interest_filter, interest: interest1, filter: filter, level: 3, level_by_admin: 3)
      FactoryBot.create(:interest_filter, interest: interest2, filter: filter, level: 2, level_by_admin: 3)
  ...
  describe '::by_skill_filters_sql' do
    ...
    it 'returns the correct SQL string' do
      skill1 = FactoryBot.build(:skill, id: 1018)
      skill2 = FactoryBot.build(:skill, id: 1019)
      skill_filters = [
        FactoryBot.build(:skill_filter, skill: skill1, id: 1, proficiency: 1, proficiency_by_admin: 1),
        FactoryBot.build(:skill_filter, skill: skill2, id: 2, proficiency: 2, proficiency_by_admin: 2)
      ]
  ...
  describe '::by_language_filters_sql' do
    # rubocop:disable Metrics/LineLength
    it 'returns the correct SQL string' do
      lang1 = FactoryBot.build(:language, id: 1033)
      lang2 = FactoryBot.build(:language, id: 1034)
      language_filters = [
        FactoryBot.build(:language_filter, language: lang1, id: 1, proficiency: 1, proficiency_by_admin: 1),
        FactoryBot.build(:language_filter, language: lang2, id: 2, proficiency: 2, proficiency_by_admin: 2)
      ]
  ...
  describe '::by_interest_filters_sql' do
    # rubocop:disable Metrics/LineLength
    it 'returns the correct SQL string' do
      interest1 = FactoryBot.build(:interest, id: 1057)
      interest2 = FactoryBot.build(:interest, id: 1058)
      interest_filters = [
        FactoryBot.build(:interest_filter, interest: interest1, id: 1, level: 1, level_by_admin: 1),
        FactoryBot.build(:interest_filter, interest: interest2, id: 2, level: 2, level_by_admin: 2)
      ]
