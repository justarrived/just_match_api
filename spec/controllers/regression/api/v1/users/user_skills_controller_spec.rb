...
RSpec.describe Api::V1::Users::UserSkillsController, regressor: true do
  ...
  it { should route(:get, '/api/v1/users/1/skills/1').to('api/v1/users/user_skills#show', user_id: '1', user_skill_id: '1') }
  it { should route(:post, '/api/v1/users/1/skills').to('api/v1/users/user_skills#create', user_id: '1') }
  it { should route(:delete, '/api/v1/users/1/skills/1').to('api/v1/users/user_skills#destroy', user_id: '1', user_skill_id: '1') }
  # === Callbacks (Before) ===
