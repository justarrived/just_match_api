...
RSpec.describe Api::V1::Users::UserLanguagesController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new UserLanguage' do
        ...
        expect {
          post :create, {user_id: user.to_param, language: {id: language.to_param}}, valid_session
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved user_language as @user_language' do
        user = FactoryGirl.create(:user)
        post :create, {user_id: user.to_param, language: {id: nil}}, valid_session
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested user_language' do
      ...
      language = user.languages.first
      expect {
        delete :destroy, {user_id: user.to_param, id: language.to_param}, valid_session
      }.to change(UserLanguage, :count).by(-1)
    end
