...
ActiveAdmin.setup do |config|
  ...
  #
  config.site_title_image = '/justarrived-logo.png'
  ...
  config.namespace :admin do
    config.route_options = { path: '' }
  end

  # The below line fixes, https://github.com/activeadmin/activeadmin/issues/3911
  # config.root_to_options = { as: :admin_root }
  #
  ...
  config.current_user_method = :authenticated_admin_user
  ...
  #
  config.before_filter :authenticate_admin
  ...
  # == Menu System
  #
  # You can add a navigation menu to be used in your application, or configure a provided
  # menu
  #
