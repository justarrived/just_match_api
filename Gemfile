...
gem 'rails', '5.2.2' # Ruby on Rails MVC framework
...
# STORAGE
gem 'aws-sdk-s3', '~> 1.30' # Upload images to AWS S3
...
# MONITORING
gem 'airbrake', '~> 7.4' # Error catcher and reporter
gem 'newrelic_rpm', '~> 5.6' # Performance monitoring
...
gem 'twilio-ruby', '~> 5.17' # Send SMS notifications

# GEO/LOCALE/LANGUAGE UTILS
gem 'banktools-se', '~> 3.0' # Validate Swedish bank account
gem 'countries', '~> 2.2', require: 'countries/global' # Country data in various locales
