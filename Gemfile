...
# STORAGE
gem 'aws-sdk-s3', '~> 1.25' # Upload images to AWS S3
...
gem 'activeadmin', '~> 1.3.0' # Admin interface - we need to peg this to v1.3.x,since v1.4 has this regression https://github.com/activeadmin/activeadmin/pull/5611
