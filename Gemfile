...
# STORAGE
gem 'aws-sdk-s3', '~> 1.19' # Upload images to AWS S3
...
gem 'newrelic_rpm', '~> 5.3' # Performance monitoring
...
gem 'arbetsformedlingen', '~> 0.5' # Gem for publishing jobs to Arbetsformedlingen (Swedish Employment Service)
...
gem 'twilio-ruby', '~> 5.12' # Send SMS notifications
