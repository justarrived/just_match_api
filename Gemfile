...
gem 'rails', '5.2.2.1' # Ruby on Rails MVC framework
...
# STORAGE
gem 'aws-sdk-s3', '~> 1.35' # Upload images to AWS S3
...
# MONITORING
gem 'airbrake', '~> 8.1' # Error catcher and reporter
gem 'newrelic_rpm', '~> 6.1' # Performance monitoring
...
gem 'twilio-ruby', '~> 5.21' # Send SMS notifications
