...
gem 'rails', '5.0.0.1' # Ruby on Rails MVC framework
...
gem 'jquery-ui-rails', '~> 5.0' # Needeed for activeadmin assets until patch is released to RubyGems (see https://github.com/activeadmin/activeadmin/commit/5b8ded8bcc1cd3ed09ea5c10fc992e47614d4bd1)
